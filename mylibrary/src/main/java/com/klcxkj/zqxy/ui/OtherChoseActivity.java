...
public class OtherChoseActivity extends BaseActivity {
    ...
    private void initview() {
        ...
        scanName.setText("扫码");
        unbind_search.setText("搜索");
        unbind_scan.setText("扫码");
    }
    ...
    private void bindclick() {
        scanBath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in =new Intent(OtherChoseActivity.this,ScanActivity.class);
        ...
        serachBath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in =new Intent(OtherChoseActivity.this,SearchBratheDeviceActivity.class);
                in.putExtra("type","4");
                startActivity(in);
            }
        });
        device_state_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(OtherChoseActivity.this,OtherActivity.class);

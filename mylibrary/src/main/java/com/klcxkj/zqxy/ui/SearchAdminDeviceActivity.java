...
public class SearchAdminDeviceActivity extends BaseActivity {
	...
	private void setAdmin() {
		if (ContextCompat.checkSelfPermission(SearchAdminDeviceActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			//权限还没有授予，需要在这里写申请权限的代码
			ActivityCompat.requestPermissions(SearchAdminDeviceActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 60);
		}
	}

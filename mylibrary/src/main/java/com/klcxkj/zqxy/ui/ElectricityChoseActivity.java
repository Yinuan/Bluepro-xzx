...
public class ElectricityChoseActivity extends BaseActivity {
    ...
    private void initview() {
        ...
        scanName.setText("扫码充电");
        unbind_search.setText("搜索充电");
        unbind_scan.setText("扫码充电");
    }
    ...
    private void bindclick() {
        scanBath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in =new Intent(ElectricityChoseActivity.this,ScanActivity.class);
        ...
        serachBath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in =new Intent(ElectricityChoseActivity.this,SearchBratheDeviceActivity.class);
                in.putExtra("type","4");
                startActivity(in);
            }
        });
        device_state_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(ElectricityChoseActivity.this,ElectricityActivity.class);

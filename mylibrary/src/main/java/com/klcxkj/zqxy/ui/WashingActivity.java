...
public class WashingActivity extends BaseActivity implements WaterCodeListener {
        ...
        if (mUserInfo.GroupID==2){
            ...
            rightTxt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    in.putExtra("capture_type", ScanActivity.CAPTURE_WASHING);
                    startActivity(in);
            ...
            dialogBuilder.withTitle(getString(R.string.tips))
                  ...
                  .withButton2Text("我知道了")
                    .setButton2Click(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            dialogBuilder.dismiss();
                            MessageEvent messageEvent =new MessageEvent("money");
    ...
    private DealRateInfo dealRateInfo;
    ...
    private void postEmptyDownRate(PostConsumeData postConsumeData) {
        ...
        RequestBody requestBody=new FormBody.Builder()
                ...
                .add("UpMoney",""+0)
                .add("PerMoney",""+ washingModelInfo.getMoney())
        ...
        if (b){
            ...
            if (dAccountId ==mUserInfo.AccID){
                postXiaoFei(true, mproductid, maccountid, mdeviceid, Integer.parseInt(accounttypeString), Integer.parseInt(consumeMoneString),
                 ...
                 messageEvent =new MessageEvent("finish_washing", true, timeid,  mproductid,  mdeviceid,
                        maccountid, accounttypeString,  usercount,  ykmoneyString,
                        consumeMoneString,  rateString,  macString);
            }else {
                postXiaoFei(false, mproductid, maccountid, mdeviceid, Integer.parseInt(accounttypeString), Integer.parseInt(consumeMoneString),
                        Integer.parseInt(ykmoneyString), timeid, usercount);
                 messageEvent =new MessageEvent("finish_washing", false, timeid,  mproductid,  mdeviceid,
                        maccountid, accounttypeString,  usercount,  ykmoneyString,
                        consumeMoneString,  rateString,  macString);
            }
       ...
       // mHandler.removeMessages(BluetoothService.MESSAGE_NO_XIAFACALLBACK);
        ...
        if (b){
           // Log.d("WashingActivity", "开始交易");
            ...
            MessageEvent messageEvent =new MessageEvent("start_washing",downRateInfo.ConsumeDT,mUserInfo.PrjID,mDeviceInfo.DevID,
                    mUserInfo.AccID,mUserInfo.GroupID+"",downRateInfo.UseCount,
                    dealRateInfo.ykMoney+"",dealRateInfo.ChargeMethod+"",mDeviceInfo.devMac);
            EventBus.getDefault().postSticky(messageEvent);
        }else {
            showStartFail();
            //将钱取消
